...
function onNavigatingTo(args: NavigatedData) {

    const page = args.object as Page;
    const scrollView = page.content as ScrollView;
    ...
    */
    ...
    const actionBar = page.getViewsByTag("ActionBar")[0] as ActionBar;
...
export { onNavigatingTo, onPageLoaded };
